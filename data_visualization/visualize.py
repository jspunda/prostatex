...
def visualize_lesions(lesions, references, lesion_info, save=False):
    """
    ...
    for i in range(lesions_flat.shape[0]):
        ...
        ax1.imshow(lesions[i], cmap='gray')
        ...
        ax2.imshow(references[i], cmap='gray')
...
if __name__ == "__main__":
    ...
    visualize_lesions(X, X_big, y, save=False)
